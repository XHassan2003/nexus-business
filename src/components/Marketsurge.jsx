...
const HomePage = () => {
  ...
  <svg
    className="w-full h-[180px] text-green-500"
  ...
  />
      ...
      <section className="py-20 bg-[#0d1117] text-white">
        <div className="max-w-6xl mx-auto text-center px-4">
          <h2 className="text-xl font-semibold mb-12">
            MarketSurge isn’t like any other stock research platform—it’s better.
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-left">
            <div>
              <h3 className="text-green-400 font-bold text-sm mb-3">Designed by a Trading Legend</h3>
              <p className="text-sm text-gray-300">
                For serious US investors. With 40+ years of experience in the market, we’ve built this for pros who want the edge, every day.
              </p>
            </div>
            <div>
              <h3 className="text-green-400 font-bold text-sm mb-3">Streamlined & Powerful</h3>
              <p className="text-sm text-gray-300">
                With less noise and more signal, your ideas are surfaced faster. Everything is purpose-built to help you research smarter.
              </p>
            </div>
            <div>
              <h3 className="text-green-400 font-bold text-sm mb-3">The Biggest Time-Saver</h3>
              <p className="text-sm text-gray-300">
                Jump straight into top-rated stocks based on proven strategies and reduce hours of research time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="font-semibold text-sm text-right">— {testimonial.name}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="bg-[#0d1117] text-gray-500 py-6 text-center border-t border-gray-700">
        <p className="text-xs">&copy; {new Date().getFullYear()} MarketSurge. All rights reserved.</p>
      </footer>
    </div>
  );
};
